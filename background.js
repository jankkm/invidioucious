...
function redirect(requestDetails) {
	if (!disabled) {
		...
		} else if (newurl.includes(settings.baseurl) && settings.usecookie && newurl.includes("quality=")) {
			newurl=newurl.substring(0, newurl.indexOf('quality=')-1);
		} else if (newurl.includes(settings.baseurl) && !settings.usecookie && newurl.includes("quality=")) {
			if (newurl.substr(newurl.indexOf('quality='), newurl.length) != settings.parameter) {
				newurl=newurl.substring(0, newurl.indexOf('quality=')-1);
			}
		} else if (newurl.includes(settings.baseurl) && !settings.usecookie && !newurl.includes("quality=")) {
